...
public class ThingTest {
    ...
    private final Thing thingWithChildren = new Thing("and", new ArrayList<Thing>(Arrays.asList(new Thing[]{
    ...
    public void testAdd() {
        ...
        thing2.addChildren(new ArrayList<Thing>(Arrays.asList(new Thing[] {
                thing1, thing1
        })));
